Profile: EICRAnonymizedOrgTeleAddrName
Parent: EICRAnonymizedOrgTeleAddr
Id: eicr-anon-org-tele-addr-name
Title: "eICR Anonymized Organization - Telecom, Address, Name"
Description: "This Organization profile represents an anonymized eCR Organization.

It is based on the **EICRAnonymizedOrgTeleAddr** profile with further constraints to require masking of name."
