...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:text/f:extension</sch:title>
    <sch:rule context="f:RelatedPerson/f:text/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:identifier/f:extension</sch:title>
